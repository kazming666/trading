...
- `Signals`: manual strategy signal generation and recent signal history.
...
Current strategy modules are framework placeholders and return `HOLD`. Signals are written to PostgreSQL in `signal_history`. They do not place orders.
